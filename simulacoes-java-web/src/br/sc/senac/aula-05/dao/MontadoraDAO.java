...
public class MontadoraDAO {
	...
	public boolean atualizar(Montadora m) {
		...
		String sql = "UPDATE MONTADORA SET NOME=?, PAIS=? WHERE ID=?";
	...
	public Montadora obterPorId(int idMontadora) {
		...
		String sql = " SELECT * FROM MONTADORA WHERE ID=? LIMIT 1";
	...
	public Montadora obterPorNome(String nome) {
		...
		String sql = " SELECT * FROM MONTADORA WHERE NOME=? LIMIT 1";
